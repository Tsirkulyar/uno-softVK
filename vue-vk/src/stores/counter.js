    ...
    actions:{
       getVKaxios3(){
        ...
        let promise = new Promise(function(resolve, reject) {
            resolve(axios.get(
            `https://cors-anywhere.herokuapp.com/https://api.vk.com/method/users.getFollowers?user_id=5178786&fields=bdate&access_token=afc49b43afc49b43afc49b43f6acd2ba11aafc4afc49b43cafb4eb6152e6f8c96801e71&v=5.131`,
            config
          ))
        });
        promise.then(
      ...
      async getVkFriends(){
        ...
        const res = await fetch(`https://cors-anywhere.herokuapp.com/https://api.vk.com/method/users.getFollowers?user_id=5178786&fields=photo_200_orig,bdate,about,activities&access_token=afc49b43afc49b43afc49b43f6acd2ba11aafc4afc49b43cafb4eb6152e6f8c96801e71&v=5.131`,config);
